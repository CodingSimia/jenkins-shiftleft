...
public class ShiftLeftEventBuildStep extends hudson.tasks.Builder implements SimpleBuildStep {
    ...
    public ShiftLeftEventBuildStep(
            String eventType,
            String dockerImage,
    ...
    public void perform(
        ...
        logger.println("[🏄] Shift Left sending event...");
        logger.println("     - Initiator:    " + initiatorToUse);
        logger.println("     - Event Type:   " + eventType);
        ...
        String[] cliCmd = {
            ...
            String.format("--event-type=%s", eventType),
        ...
        if (channel != null) {
            ...
            try {
                ...
                logger.println("[✅] Sending Event complete");
            } catch (Exception e) {
                logger.println("[❌] Error sending event: " + e.getMessage());
            }
        }
    }

    @Extension
    @Symbol("shiftLeftEvent")
    public static final class DescriptorImpl extends hudson.tasks.BuildStepDescriptor<hudson.tasks.Builder> {
        @NonNull
        @Override
        public String getDisplayName() {
            return "Shift Left Event";
        }
        ...
        public ListBoxModel doFillEventTypeItems() {
            ListBoxModel items = new ListBoxModel();
            items.add("Image Publish", "IMAGE_PUBLISH");
            items.add("Image Deploy", "IMAGE_DEPLOY");
            return items;
        }
